...
fn car_factory(color: String, motor: Transmission, roof: bool, miles: u32) -> Car {
    ...
    let mut first_msg: String;
    if quality.0 == Age::Used {
        first_msg = String::from("Prepare a used car");
    } else {
        first_msg = String::from("Build a new car");
    }

    let mut second_msg: String;
    if roof {
        second_msg = String::from("Hard top");
    } else {
        second_msg = String::from("Convertible");
    }

    println!("{}: {:?}, {}, {}, {} miles", first_msg, motor, color, second_msg, miles);
